...
final class TagTests: XCTestCase {
    ...
    func testRepositoryTags() throws {
        ...
        try FileManager.default.withTemporaryDirectory { local in
            ...
            guard case let .annotated(annotatedID, annotatedTag) = tag0 else { XCTFail(); return }
            ...
            guard case let .lightweight(lightweightID, lightweightTarget) = tag1 else { XCTFail(); return }
