...
final class ReferenceTests: XCTestCase {
  ...
  func testRepositoryReferences() throws {
    ...
    try FileManager.default.withTemporaryDirectory { local in
      ...
      XCTAssertEqual(
        try references.value(at: 0).target.description, "b1d2dbab22a62771db0c040ccf396dbbfdcef052")
      XCTAssertEqual(
      ...
      XCTAssertEqual(
        try references.value(at: 1).target.description, "b1d2dbab22a62771db0c040ccf396dbbfdcef052")
      XCTAssertEqual(
      ...
      XCTAssertEqual(
        try references.value(at: 2).target.description, "b1d2dbab22a62771db0c040ccf396dbbfdcef052")
      XCTAssertEqual(
      ...
      XCTAssertEqual(
        try references.value(at: 3).target.description, "17e26bc76cff375603e7173dac31e5183350e559")
      XCTAssertEqual(
      ...
      XCTAssertEqual(
        try references.value(at: 4).target.description, "b1d2dbab22a62771db0c040ccf396dbbfdcef052")
      XCTAssertEqual(
