...
struct CommitTests {
  ...
  @Test func repositoryCommitForString() throws {
    ...
    try FileManager.default.withTemporaryDirectory { local in
      ...
      #expect(commit.committer.date == Date(timeIntervalSince1970: 1_595_676_911))
      #expect(commit.committer.timeZone == TimeZone(secondsFromGMT: 3600))
      #expect(commit.debugDescription == "Commit(id: 41c1435, summary: Add a file)")
    }
  }
  ...
  @Test func repositoryCommits() throws {
    ...
    try FileManager.default.withTemporaryDirectory { local in
      ...
      #expect(try parentIDs.value(at: 0).description == "17e26bc76cff375603e7173dac31e5183350e559")
      #expect(try parentIDs.value(at: 1).description == "c8b08c2ed176eaaf7cea877f774319a27684870a")
    }
  }
