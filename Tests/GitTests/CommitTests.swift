...
final class CommitTests: XCTestCase {
  ...
  func testRepositoryCommitForString() throws {
    ...
    try FileManager.default.withTemporaryDirectory { local in
      ...
      XCTAssertEqual(commit.author.date, Date(timeIntervalSince1970: 1_595_676_911))
      ...
      XCTAssertEqual(commit.committer.date, Date(timeIntervalSince1970: 1_595_676_911))
  ...
  func testRepositoryCommits() throws {
    ...
    try FileManager.default.withTemporaryDirectory { local in
      ...
      XCTAssertEqual(last.author.date, Date(timeIntervalSince1970: 1_595_183_161))
      ...
      XCTAssertEqual(last.committer.date, Date(timeIntervalSince1970: 1_595_183_161))
      ...
      XCTAssertEqual(
        try parentIDs.value(at: 0).description, "17e26bc76cff375603e7173dac31e5183350e559")
      XCTAssertEqual(
        try parentIDs.value(at: 1).description, "c8b08c2ed176eaaf7cea877f774319a27684870a")
    }
  }
