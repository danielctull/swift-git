...
struct CommitTests {
  ...
  func testRepositoryCommitForString() throws {
    ...
    try FileManager.default.withTemporaryDirectory { local in
      ...
      XCTAssertEqual(
        commit.debugDescription,
        "Commit(id: 41c1435, summary: Add a file)"
      )
    }
  }
  ...
  func testRepositoryCommits() throws {
    ...
    try FileManager.default.withTemporaryDirectory { local in
      ...
      XCTAssertEqual(
        last.author.date,
        Date(timeIntervalSince1970: 1_595_183_161)
      )
      ...
      XCTAssertEqual(
        ...
        "Commit(id: 17e26bc, summary: Add readme)"
      )
  ...
  func testCommitTree() throws {
    ...
    try FileManager.default.withTemporaryDirectory { local in
      ...
      XCTAssertEqual(
        tree.id.description,
        "017acad83ffb24d951581417f150bf31673e45b6"
      )
