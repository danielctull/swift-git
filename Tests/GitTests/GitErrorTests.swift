...
final class GitErrorTests: XCTestCase {
    ...
    func testDescription() {
        XCTAssertEqual(GitError(domain: .none, code: .unknown, message: "message").description, "[None | Unknown] message")
        XCTAssertEqual(GitError(domain: .noMemory, code: .notFound, message: "message").description, "[No Memory | Not Found] message")
        XCTAssertEqual(GitError(domain: .os, code: .exists, message: "message").description, "[OS | Exists] message")
        XCTAssertEqual(GitError(domain: .invalid, code: .ambiguous, message: "message").description, "[Invalid | Ambiguous] message")
        XCTAssertEqual(GitError(domain: .reference, code: .buffer, message: "message").description, "[Reference | Buffer] message")
        XCTAssertEqual(GitError(domain: .zlib, code: .bareRepository, message: "message").description, "[zlib | Bare Repository] message")
        XCTAssertEqual(GitError(domain: .repository, code: .unbornBranch, message: "message").description, "[Repository | Unborn Branch] message")
        XCTAssertEqual(GitError(domain: .config, code: .unmerged, message: "message").description, "[Config | Unmerged] message")
        XCTAssertEqual(GitError(domain: .regex, code: .nonFastForward, message: "message").description, "[Regex | Non Fast-Forward] message")
        XCTAssertEqual(GitError(domain: .odb, code: .invalidSpec, message: "message").description, "[ODB | Invalid Spec] message")
        XCTAssertEqual(GitError(domain: .index, code: .conflict, message: "message").description, "[Index | Conflict] message")
        XCTAssertEqual(GitError(domain: .object, code: .locked, message: "message").description, "[Object | Locked] message")
        XCTAssertEqual(GitError(domain: .net, code: .modified, message: "message").description, "[Net | Modified] message")
        XCTAssertEqual(GitError(domain: .tag, code: .auth, message: "message").description, "[Tag | Auth] message")
        XCTAssertEqual(GitError(domain: .tree, code: .certificate, message: "message").description, "[Tree | Certificate] message")
        XCTAssertEqual(GitError(domain: .indexer, code: .applied, message: "message").description, "[Indexer | Applied] message")
        XCTAssertEqual(GitError(domain: .ssl, code: .peel, message: "message").description, "[SSL | Peel] message")
        XCTAssertEqual(GitError(domain: .submodule, code: .endOfFile, message: "message").description, "[Submodule | End Of File] message")
        XCTAssertEqual(GitError(domain: .thread, code: .invalid, message: "message").description, "[Thread | Invalid] message")
        XCTAssertEqual(GitError(domain: .stash, code: .uncommitted, message: "message").description, "[Stash | Uncommitted] message")
        XCTAssertEqual(GitError(domain: .checkout, code: .directory, message: "message").description, "[Checkout | Directory] message")
        XCTAssertEqual(GitError(domain: .fetchHead, code: .mergeConflict, message: "message").description, "[Fetch HEAD | Merge Conflict] message")
        XCTAssertEqual(GitError(domain: .merge, code: .passthrough, message: "message").description, "[Merge | Passthrough] message")
        XCTAssertEqual(GitError(domain: .ssh, code: .iteratorOver, message: "message").description, "[SSH | Iterator Over] message")
        XCTAssertEqual(GitError(domain: .filter, code: .retry, message: "message").description, "[Filter | Retry] message")
        XCTAssertEqual(GitError(domain: .revert, code: .mismatch, message: "message").description, "[Revert | Mismatch] message")
        XCTAssertEqual(GitError(domain: .callback, code: .indexDirty, message: "message").description, "[Callback | Index Dirty] message")
        XCTAssertEqual(GitError(domain: .cherrypick, code: .applyFail, message: "message").description, "[Cherrypick | Apply Fail] message")
        XCTAssertEqual(GitError(domain: .describe, code: .unknown).description, "[Describe | Unknown] General error.")
        XCTAssertEqual(GitError(domain: .rebase, code: .notFound).description, "[Rebase | Not Found] Requested object could not be found.")
        XCTAssertEqual(GitError(domain: .filesystem, code: .exists).description, "[File System | Exists] Object exists preventing operation.")
        XCTAssertEqual(GitError(domain: .patch, code: .ambiguous).description, "[Patch | Ambiguous] More than one object matches.")
        XCTAssertEqual(GitError(domain: .worktree, code: .buffer).description, "[Worktree | Buffer] Output buffer too short to hold data.")
        XCTAssertEqual(GitError(domain: .sha, code: .bareRepository).description, "[SHA | Bare Repository] Operation not allowed on bare repository.")
        XCTAssertEqual(GitError(domain: .http, code: .unbornBranch).description, "[HTTP | Unborn Branch] HEAD refers to branch with no commits.")
        XCTAssertEqual(GitError(domain: .internal, code: .unmerged).description, "[Internal | Unmerged] Merge in progress prevented operation.")
    }
