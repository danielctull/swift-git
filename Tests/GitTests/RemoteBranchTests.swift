...
final class RemoteBranchTests: XCTestCase {
  ...
  func testRepositoryRemoteBranches() throws {
    ...
    try FileManager.default.withTemporaryDirectory { local in
      ...
      XCTAssertEqual(
        try remoteBranches.value(at: 0).reference.description, "refs/remotes/origin/HEAD")
      ...
      XCTAssertEqual(
        try remoteBranches.value(at: 1).reference.description, "refs/remotes/origin/main")
