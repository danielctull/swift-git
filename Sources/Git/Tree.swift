...
public struct Tree: Equatable, Hashable, Identifiable, Sendable, GitPointerInitialization {
...
extension Tree {
    ...
    public struct Entry: Equatable, Hashable, Sendable, GitPointerInitialization {
        let pointer: GitPointer
